...
def scan_transients(df: pd.DataFrame, *,
                    mjd_col="mjd", resid_col="resid", sigma_col="sigma",
                    exclude_bad_col="bad",
                    tau_rec_days=7.0, window_mult=5.0, min_points=6,
                    delta_chi2_thresh=25.0, suppress_overlap=True) -> pd.DataFrame:
