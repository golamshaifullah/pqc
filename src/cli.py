"""Command-line interface for PTA QC.

This module wires configuration flags to :func:`pqc.pipeline.run_pipeline`.
It is intentionally minimal and suitable for scripting.

Example:
    python -m pqc.cli --par DR3full/J1909-3744/J1909-3744.par --out out.csv
"""
...
def main() -> None:
    ...
    This function parses CLI options, constructs config objects, runs the
    pipeline, and writes the output CSV.
    """
